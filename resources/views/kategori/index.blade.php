            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="mb-6">
                    <p class="text-gray-600">
                        ...
                        Klik tombol <span class="font-semibold text-blue-600">Tambah</span> untuk menambahkan kategori baru.
                    </p>
                </div>

                <!-- Form Cari -->
                <form action="{{ route('kategori.index') }}" method="GET" class="flex items-center mb-6">
                    ...
                    <table class="w-full bg-white">
                        <thead class="bg-gray-100">
                            <tr class="text-gray-700 text-left">
                                <th class="py-3 px-4 border-b border-gray-300">ID Kategori</th>
                                <th class="py-3 px-4 border-b border-gray-300">Nama Kategori</th>
                                <th class="py-3 px-4 border-b border-gray-300">Keterangan</th>
                        ...
                        <tbody>
                            @forelse($kategori as $k)
                                <tr class="hover:bg-gray-50 border-b border-gray-200">
                                    ...
                                    <td class="py-3 px-4">{{ $k->keterangan }}</td>
                                    <td class="py-3 px-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <!-- Tombol Hapus -->
                                            <form id="delete-form-{{ $k->id }}" action="{{ route('kategori.destroy', $k->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                ...
                <!-- Tombol Tambah & Pagination -->
                <div class="mt-6 flex items-center justify-between">
                    <!-- Tombol Tambah Kategori -->
                    <a href="{{ route('kategori.create') }}"
                       class="inline-block bg-green-600 text-white px-5 py-2 rounded-lg hover:bg-green-700">
